...
用法:
    python agent_bench/uploader/upload_example.py <待上传目录或文件路径>
"""
...
def main():
    ...
    uploader = create_uploader(
        ...
        project_id=project_client_config["project_id"],
        client_id=project_client_config["client_id"],
        client_secret=project_client_config["client_secret"],
        developer_id=project_client_config["developer_id"],
        credential_type=project_client_config["type"],
        region=project_client_config["region"],
